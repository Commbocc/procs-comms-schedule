...
function doWatch(source2, cb, {
  ...
  const reactiveGetter = (source22) => deep === true ? source22 : traverse(source22, deep === false ? 1 : void 0);
  let getter;
...
const _hoisted_1$1 = { class: "table table-striped table-bordered table-responsive table-sm" };
const _hoisted_2$1 = /* @__PURE__ */ createBaseVNode("thead", { class: "bg-dark text-white" }, [
  /* @__PURE__ */ createBaseVNode("tr", null, [
    /* @__PURE__ */ createBaseVNode("th", null, "Item"),
    /* @__PURE__ */ createBaseVNode("th", null, "Commissioner"),
    /* @__PURE__ */ createBaseVNode("th", null, "Date Requested"),
    /* @__PURE__ */ createBaseVNode("th", null, "Date Needed"),
    /* @__PURE__ */ createBaseVNode("th", null, "Presentation Date")
  ])
], -1);
const _hoisted_3$1 = { class: "text-center" };
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("table", _hoisted_1$1, [
    ...
    createBaseVNode("tbody", null, [
      (openBlock(true), createElementBlock(Fragment, null, renderList($setup.requests.data, ({ id, fields: request2 }) => {
        return openBlock(), createElementBlock("tr", { key: id }, [
          createBaseVNode("td", null, toDisplayString(request2.Name), 1),
          createBaseVNode("td", null, toDisplayString(request2.Commissioner), 1),
          createBaseVNode("td", _hoisted_3$1, toDisplayString(request2.DateRequested), 1),
          createBaseVNode("td", _hoisted_4$1, toDisplayString(request2.DateNeeded), 1),
          createBaseVNode("td", _hoisted_5$1, toDisplayString(request2.PresentationDate), 1)
        ]);
      }), 128))
    ])
  ]);
}
var RequestsComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1]]);
const _sfc_main = {
  setup() {
    fetchSchedule();
    return { schedule };
...
const _hoisted_1 = { class: "table table-striped table-bordered table-responsive table-sm" };
const _hoisted_2 = /* @__PURE__ */ createBaseVNode("thead", null, [
  /* @__PURE__ */ createBaseVNode("tr", null, [
    /* @__PURE__ */ createBaseVNode("th", null, "Date & Type"),
    /* @__PURE__ */ createBaseVNode("th", null, "Name"),
    /* @__PURE__ */ createBaseVNode("th", null, "Details")
  ])
], -1);
const _hoisted_3 = { class: "mb-0" };
const _hoisted_4 = { key: 0 };
const _hoisted_5 = /* @__PURE__ */ createBaseVNode("strong", null, "Quarterly Awards", -1);
const _hoisted_6 = [
  _hoisted_5
];
const _hoisted_7 = { key: 1 };
const _hoisted_8 = /* @__PURE__ */ createBaseVNode("em", null, "Pending submission of COIN request.", -1);
const _hoisted_9 = [
  _hoisted_8
];
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("table", _hoisted_1, [
    _hoisted_2,
    createBaseVNode("tbody", null, [
      (openBlock(true), createElementBlock(Fragment, null, renderList($setup.schedule.data, ({ id, fields: item }) => {
        return openBlock(), createElementBlock("tr", { key: id }, [
          createBaseVNode("td", null, toDisplayString(item.Name), 1),
          createBaseVNode("td", null, toDisplayString(item.Excerpt), 1),
          createBaseVNode("td", null, [
            createBaseVNode("ul", _hoisted_3, [
              item.Quarterly ? (openBlock(), createElementBlock("li", _hoisted_4, _hoisted_6)) : createCommentVNode("", true),
              $setup.schedule.Pending ? (openBlock(), createElementBlock("li", _hoisted_7, _hoisted_9)) : createCommentVNode("", true),
              item.Commissioner ? (openBlock(), createElementBlock("li", _hoisted_10, " Commissioner: " + toDisplayString(item.Commissioner), 1)) : createCommentVNode("", true)
            ])
          ])
        ]);
      }), 128))
...
var ScheduleComponent = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
const HcProcsComms = {
  Requests: (props = {}) => createApp(RequestsComponent, props),
  Schedule: (props = {}) => createApp(ScheduleComponent, props)
};
export { HcProcsComms as default };
